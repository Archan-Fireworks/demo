            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('affiliate.store') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            <label class="control-label">{{ translate('User Registration Bonus')}}</label>
                        </div>
                        <div class="col-lg-6">
                            @php
                            ...
                            @endphp
                            <input type="number" min="0" step="0.01" max="100" class="form-control" name="percentage" value="{{ $percentage }}" placeholder="Amount" required>
                        </div>
                        <div class="col-lg-2">
