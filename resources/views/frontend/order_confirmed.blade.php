        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    <div class="row gutters-8 sm-gutters-10">
                        <div class="col done">
                            <div class="text-center border border-bottom-6px p-2 text-success rounded-4">
                        ...
                        <div class="col active">
                            <div class="text-center border border-bottom-6px p-2 text-primary rounded-4">
                                ...
                                <h3 class="fs-14 fw-600 d-none d-lg-block">{{ translate('4. Confirmation') }}
                                </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center py-4 mb-0">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" class=" mb-3">
                            <g id="Group_23983" data-name="Group 23983" transform="translate(-978 -481)">
                              <circle id="Ellipse_44" data-name="Ellipse 44" cx="18" cy="18" r="18" transform="translate(978 481)" fill="#008000"/>
                                        ...
                                        <div class="col-xl-5 col-md-6 ml-auto mr-0">
                                            <table class="table ">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th class="py-2">{{ translate('Paid using Wallet')}}</th>
                                                        <td class="text-right pr-0 py-2">
                                                            <span>{{ single_price($order->wallet_discount) }}</span>
                                                        </td>
                                                    </tr>
                                                    @endif
                                                    <!-- Total -->
