                        ...
                        @else
                            ...
                            <div class="d-none d-xl-block ml-auto mr-0">
                                    ...
                                    <span class="d-flex align-items-center nav-user-info ml-3">
                                        ...
                                        <a href="javascript::void(0)" onclick="showLoginModal()" class="text-reset opacity-60 hov-opacity-100 hov-text-primary fs-12 d-inline-block border-right border-soft-light border-width-2 pr-2 ml-3">Login</a>
                                        <a href="javascript::void(0)" onclick="showSignupModal()" class="text-reset opacity-60 hov-opacity-100 hov-text-primary fs-12 d-inline-block py-2 pl-2">Signup</a>
                                    </span>
                            </div>
            ...
            @else
                ...
                <span class="d-flex align-items-center nav-user-info pl-4">
                    ...
                    <a href="javascript::void(0)" onclick="showSignupModal()"
                        class="text-reset opacity-60 hov-opacity-100 hov-text-primary fs-12 d-inline-block py-2 pl-2">{{ translate('Signup') }}</a>
                </span>
            @endauth
            <hr>
