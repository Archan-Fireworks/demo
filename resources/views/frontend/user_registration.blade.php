                                    ...
                                    <div class="pt-3 pt-lg-4">
                                        <div class="">
                                            <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                                ...
                                                <!-- OTP -->
                                                <div class="form-group otp_box d-none">
                                                    <label for="otp_confirmation" class="fs-12 fw-700 text-soft-dark">{{  translate('OTP') }}</label>
                                                    <input type="text" class="form-control rounded-0" placeholder="{{  translate('OTP') }}" name="otp_confirmation">
                                                </div>
                                                ...
                                                <div class="mb-4 mt-4 otp_button">
                                                    <button type="button" class="btn btn-primary btn-block fw-600 rounded-4">{{  translate('Get OTP') }}</button>
                                                </div>

                                                <!-- Submit Button -->
                                                <div class="mb-4 mt-4 d-none submit_button">
...
@section('script')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            // Show OTP box and hide email field
            $('.otp_button button').click(function(){
                ...
                $.ajax({
                    url: '{{ route("generate.otp",'.phone.') }}',
                    method: 'POST',
                    success: function(response){
                        if(response.status == 'success'){
                            AIZ.plugins.notify('warning', '{{ translate('OTP has been sent to your phone.') }}');
                        } else {
                            AIZ.plugins.notify('warning', '{{ translate('Please try again.') }}');
                        }
                    }
                });
            });
