            ...
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    <div class="row gutters-8 sm-gutters-10">
                        <div class="col done">
                            <div class="text-center border border-bottom-6px p-2 rounded-4 text-success">
                        ...
                        <div class="col active">
                            <div class="text-center border border-bottom-6px p-2 rounded-4 text-primary">
                        ...
                        <div class="col">
                            <div class="text-center border border-bottom-6px p-2 rounded-4">
                                            ...
                                            <div class="col-6 col-xl-3 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    ...
                                                    <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                        ...
                                                        <span class="d-block text-center">
                                                            <span
                                                                class="d-block fw-600 fs-15">{{ translate('Fast Delivery') }}</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                                    ...
                                    <div class="py-4 px-4 text-center bg-soft-warning mt-4">
                                        ...
                                        @if(Auth::user()->balance > 0)
                                            <label class="aiz-checkbox">
                                                <input type="checkbox" name="apply_wallet_balance">
                                                <span class="aiz-square-check"></span>
                                                <span>{{ translate('Apply from my wallet') .' '. single_price(round(Auth::user()->balance))}}</span>
                                            </label>
                                        @endif
