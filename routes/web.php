...
Route::get('/sitemap.xmll', [SitemapController::class,'index']);
...
Route::controller(AuthController::class)->group(function () {
    Route::post('/check-phone-exists', 'checkPhoneExists')->name('check-phone-exists');
...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/categories', 'all_categories')->name('categories.all');
        Route::get('/quick-purchase', 'all_categories_quick')->name('categories.quick');
...
Route::controller(CartController::class)->group(function () {
    ...
    Route::post('/cart/addtocart2', 'addToCart2')->name('cart.addToCart2');
...
Route::group(['middleware' => ['customer', 'unbanned']], function () {
